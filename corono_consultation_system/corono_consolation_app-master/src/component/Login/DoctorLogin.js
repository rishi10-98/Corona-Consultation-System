...
import DoctorLoginAction from './DoctorLoginAction'
...
function DoctorLogin()
{
    ...
    return(
        ...
        <div id="SgIForm" className="container-fluid pt-4" style={{
            ...
            <Route path="/doctorloginactions">
                <DoctorLoginAction userName={userName} password={password}/>
            </Route>
        
                    <h4 className="font-weight-bold mb-2 pt-3">Doctor Login Form </h4>
...
<div className="text-danger" >
  ...
  <p id="error" style={{backgroundColor:""}}></p>
      ...
      <Link to="/doctorloginactions"   id="formlogin"   style={{pointerEvents:"none",color:"black"}} >Login</Link>
  </div>
      </div>
      </div>
      </div>
