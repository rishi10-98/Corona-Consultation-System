...
import AdminLoginAction from './AdminLoginAction'
...
function AdminLogin()
{
    ...
    return(
        ...
        <div id="SgIForm" className="container-fluid pt-4" style={{
            ...
            <Route path="/adminloginactions">
                <AdminLoginAction userName={userName} password={password}/>
            </Route>
        
                    <h4 className="font-weight-bold mb-2 pt-3">Admin Login Form </h4>
...
<div className="text-danger" >
  ...
  <p id="error" style={{backgroundColor:""}}></p>
      ...
      <Link to="/adminloginactions"   id="formlogin"   style={{pointerEvents:"none",color:"black"}} >Login</Link>
  </div>
      </div>
      </div>
      </div>
